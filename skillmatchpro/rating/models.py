...
class Rating(models.Model):
    ...
    rateduserid = models.ForeignKey('Userinfo', models.DO_NOTHING, db_column='ratedUserID', blank=True, null=True, related_name='ratings_received')
    ratingbyuserid = models.ForeignKey('Userinfo', models.DO_NOTHING, db_column='ratingByUserID', blank=True, null=True, related_name='ratings_given')
