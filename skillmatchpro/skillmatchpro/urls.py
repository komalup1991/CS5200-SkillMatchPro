...
urlpatterns = [
     ...
     path("category/<str:category>",homePage_views.postsOfCategory, name='category-page'),
     path("search/", homePage_views.postsOfSearch, name='search'),

path('dispute_details/<int:dispute_id>/', adminHomePage_views.dispute_detail_view, name='dispute_detail_view'),
path('dispute_details/', adminHomePage_views.dispute_details, name='dispute_details'),
path('settling_dispute/', adminHomePage_views.settling_dispute_view, name='settling_dispute_view'),
path('resolve_ind/<int:dispute_id>/', adminHomePage_views.resolve_ind_views, name='resolve_ind_views'),
path('payment_details/<int:payment_id>/', adminHomePage_views.payment_detail_view, name='payment_detail_view'),
path('payment_details/', adminHomePage_views.payment_details, name='payment_details'),
